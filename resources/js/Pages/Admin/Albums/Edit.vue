...
const form = useForm({
    ...
    cover_image: null,
    display_order: props.album.display_order,
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Album: {{ album.title }}</h2>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div v-if="album.cover_image" class="mb-2">
                                <img :src="`/storage/${album.cover_image}`" :alt="album.title" class="h-32 rounded">
